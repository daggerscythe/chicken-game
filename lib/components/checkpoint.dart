...
class Checkpoint extends SpriteAnimationComponent with HasGameReference<PixelGame>, CollisionCallbacks{
  Checkpoint({
    position,
    size,
  ...
  FutureOr<void> onLoad() {
    // debugMode = true;
    add(RectangleHitbox(
      position: Vector2(18, 56), // 18 from the left and 56 from the top
      size: Vector2(12, 8),
